...
(
   ...
   attributes           varchar(200) comment '参数',
   state                timestamp comment '作用域',
   ...
   authorization_code_metadata varchar(1000) comment 'authorization code 元数据',
   ...
   oidc_id_token_value  varchar(100) comment 'oidc token',
